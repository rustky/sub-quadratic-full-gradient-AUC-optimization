...
#SBATCH --output=/projects/genomic-ml/sub-quadratic-full-gradient-AUC-optimization/app/results/test/error_10.txt
...
python3 temp_driver.py 10 0.1 square_hinge_test .0001 ./results/test CIFAR10 ResNet20 SGD 10
